...
public class ModDataComponents {
    // Creates Data Component "COORDINATES"
    public static final DataComponentType<List<BlockPos>> COORDINATES = register("coordinates",
            builder -> builder
                    .persistent(BlockPos.CODEC.listOf())
                    .networkSynchronized(ByteBufCodecs.collection(ArrayList::new, BlockPos.STREAM_CODEC)));
